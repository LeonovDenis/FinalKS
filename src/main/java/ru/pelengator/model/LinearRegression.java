...
public class LinearRegression {
    ...
    public static void main(String[] args) {
        double[]   x = new double[]{25, 25, 25, 25, 25, 50, 50,50,50,50}; // Consecutive hours developer codes
      //  double[] y = new double[]{4, 5, 7, 10, 15, 20, 40}; // Number of bugs produced
        double[] y = new double[]{4096, 3300, 2918, 5952, 3402, 10547, 3892,3651,827,10418}; // Number of bugs produced
