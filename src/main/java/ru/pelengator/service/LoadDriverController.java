...
public class LoadDriverController implements Initializable {
    ...
    private void autoConfig(boolean b) {
        ...
        fieldOptions.get(13).setText(b ? "0.1136" : "0.007317");
        fieldOptions.get(14).setText(b ? "0.1136" : "0.088174");
        fieldOptions.get(15).setText(b ? "900" : "900");//todo рассчитать размер линзы и коэф. увеличения
        fieldOptions.get(16).setText(b ? "900" : "900");
        resetItogFields();
    }
